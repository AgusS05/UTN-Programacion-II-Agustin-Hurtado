...
public class Main {
    public static void main(String[] args) {
        ...
        Profesor pA = new Profesor("P101", "Lic. Ester Gómez ", "Algoritmos y Estructuras");
        Profesor pB = new Profesor("P102", "Dr. Daniel Perez", "Bases de Datos");
        Profesor pC = new Profesor("P103", "Ing. Leticia López", "POO y Colecciones");
